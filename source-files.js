...
sourcesIndex["polkadot_node_core_dispute_coordinator"] = {"name":"","dirs":[{"name":"real","dirs":[{"name":"db","files":["mod.rs","v1.rs"]},{"name":"ordering","files":["mod.rs"]},{"name":"participation","dirs":[{"name":"queues","files":["mod.rs"]}],"files":["mod.rs"]}],"files":["backend.rs","initialized.rs","mod.rs","spam_slots.rs"]}],"files":["error.rs","lib.rs","metrics.rs","status.rs"]};
